...
class EntrepreneurListWidget extends StatelessWidget {
  const EntrepreneurListWidget({
    super.key,
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return ShimmerEntrepreneurs(screenHeight: screenHeight, screenWidth: screenWidth);
          }
